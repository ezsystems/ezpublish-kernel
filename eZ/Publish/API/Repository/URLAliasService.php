...
interface URLAliasService
{
     ...
     *
     * If one of the filter parameters ($custom, $languageCode, $context) is
     * null, any value for this property is valid.
     *
     * @param \eZ\Publish\API\Repository\Values\Content\Location $location
     ...
     * @return \eZ\Publish\API\Repository\Values\Content\URLAlias[]
     */
    public function listLocationAliases( Location $location, $custom = true, $languageCode = null, $context = null );
     ...
     * @return \eZ\Publish\API\Repository\Values\Content\URLAlias
     *
     * @TODO Add new optional $context parameter.
     */
