...
use eZ\Publish\Core\FieldType\Url\Type;
use eZ\Publish\Core\Base\Exceptions\InvalidArgumentType;

/**
 * Url field type is not searchable in Legacy search engine, but will
 ...
 */
class SearchableUrl extends Type
{
    ...
    {
        $fieldTypeFQN = 'eZ\\Publish\\Core\\FieldType\\Url\\Value';
