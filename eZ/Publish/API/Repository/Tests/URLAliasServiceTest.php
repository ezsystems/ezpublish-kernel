...
DOCBOOK
     ...
     */
    protected function assertUrlIsHistory(string $lookupUrl, int $expectedDestination)
    {
     ...
     * @param int $expectedDestination Expected Location ID
     */
    protected function assertUrlIsCurrent(string $lookupUrl, int $expectedDestination)
    {
     ...
     * @throws \eZ\Publish\API\Repository\Exceptions\UnauthorizedException
     */
    protected function changeContentTypeUrlAliasSchema(string $contentTypeIdentifier, string $newUrlAliasSchema)
    {
