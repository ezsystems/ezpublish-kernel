...
class SearchServiceLocationTest extends BaseTest
{
     ...
     */
    public function testFindLocationsFiltered( LocationQuery $query, $fixture, $closure = null )
    {
     ...
     * @depends eZ\Publish\API\Repository\Tests\RepositoryTest::testGetSearchService
     */
    public function testQueryLocations( LocationQuery $query, $fixture, $closure = null )
    {
        $this->assertQueryFixture( $query, $fixture, $closure );
    }
     ...
     * @depends eZ\Publish\API\Repository\Tests\RepositoryTest::testGetSearchService
     */
    public function testFieldFiltersCaseSensitivity( LocationQuery $query )
    {
                ...
                new LocationQuery(
                    array(
                        ...
                        'sortClauses' => array(
                            ...
                            new SortClause\ContentName( LocationQuery::SORT_ASC )
                        )
                    )
                ),
            ...
            array(
                new LocationQuery(
                    array(
                        ...
                        'limit' => null,
                        'sortClauses' => array(
                            new SortClause\Field( "folder", "name", LocationQuery::SORT_ASC, "eng-US" ),
                            new SortClause\ContentId(),
                        )
                    )
                ),
            ...
            array(
                new LocationQuery(
                    array(
                        ...
                        'limit' => null,
                        'sortClauses' => array(
                            new SortClause\Field( "template_look", "title", LocationQuery::SORT_ASC ),
                            new SortClause\ContentId(),
                        )
                    )
                ),
     ...
     * @depends eZ\Publish\API\Repository\Tests\RepositoryTest::testGetSearchService
     */
    public function testFindAndSortLocations( LocationQuery $query, $fixture, $closure = null )
    {
        $this->assertQueryFixture( $query, $fixture, $closure );
    }
