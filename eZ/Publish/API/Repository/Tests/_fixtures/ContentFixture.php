    ...
    array(
        ...
        11 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\ContentInfoStub(
            array(
                ...
                "published" => true,
                "ownerId" => 14,
                "modificationDate" => new \DateTime( "@1343140542" ),
        ...
        14 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\ContentInfoStub(
            array(
                ...
                "published" => true,
                "ownerId" => 14,
                "modificationDate" => new \DateTime( "@1343140540" ),
        ...
        57 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\ContentInfoStub(
            array(
                ...
                "published" => true,
                "ownerId" => 14,
                "modificationDate" => new \DateTime( "@1196268696" ),
                "publishedDate" => new \DateTime( "@1195480486" ),
                "alwaysAvailable" => true,
        ...
        58 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\ContentInfoStub(
            array(
                ...
                "published" => true,
                "ownerId" => 14,
                "modificationDate" => new \DateTime( "@1332927282" ),
                "publishedDate" => new \DateTime( "@1332927205" ),
                "alwaysAvailable" => false,
        ...
        59 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\ContentInfoStub(
            array(
                ...
                "published" => true,
                "ownerId" => 14,
                "modificationDate" => new \DateTime( "@1343140541" ),
                "publishedDate" => new \DateTime( "@1343140541" ),
                "alwaysAvailable" => true,
    ...
    59,
        ...
        508 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\VersionInfoStub(
            array(
                ...
                "modificationDate" => new \DateTime( "@1343140541" ),
                "creatorId" => 14,
                "creationDate" => new \DateTime( "@1343140541" ),
                "initialLanguageCode" => "eng-US",
                "languageCodes" => array(
                ),
                "repository" => $this,
        ...
        506 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\VersionInfoStub(
            array(
                ...
                "modificationDate" => new \DateTime( "@1343140540" ),
                "creatorId" => 14,
                "creationDate" => new \DateTime( "@1343140540" ),
                "initialLanguageCode" => "eng-US",
                "languageCodes" => array(
                ),
                "repository" => $this,
        ...
        504 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\VersionInfoStub(
            array(
                ...
                "modificationDate" => new \DateTime( "@1196268696" ),
                "creatorId" => 14,
                "creationDate" => new \DateTime( "@1196268655" ),
        ...
        505 => new \eZ\Publish\API\Repository\Tests\Stubs\Values\Content\VersionInfoStub(
            array(
                ...
                "modificationDate" => new \DateTime( "@1332927282" ),
                "creatorId" => 14,
                "creationDate" => new \DateTime( "@1332927277" ),
                "initialLanguageCode" => "eng-GB",
                "languageCodes" => array(
                ),
                "repository" => $this,
