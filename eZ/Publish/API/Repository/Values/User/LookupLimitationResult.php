...
/**
 * File containing the eZ\Publish\API\Repository\Values\User\LookupLimitation class.
 *
...
final class LookupLimitationResult extends ValueObject
{
     ...
     */
    public function __construct(bool $hasAccess, array $lookupPolicyLimitations = [])
    {
        parent::__construct();
