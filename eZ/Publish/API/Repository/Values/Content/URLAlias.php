 ...
 * @property-read mixed $destination If type = URLAlias::LOCATION it is a LocationInfo otherwise a string (e.g. /content/search)
...
class URLAlias extends ValueObject
{
    ...
    /**
     * If type = URLAlias::LOCATION it is a LocationInfo
