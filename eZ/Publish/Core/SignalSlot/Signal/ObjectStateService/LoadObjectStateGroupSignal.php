<?php
/**
 * LoadObjectStateGroupSignal class
 *
 ...
 */
class LoadObjectStateGroupSignal extends Signal
{
    /**
     * ObjectStateGroupId
     *
     ...
     */
    public function __construct( $objectStateGroupId )
    {
        $this->objectStateGroupId = $objectStateGroupId;
    }
}
