...
class DocbookToXhtml5EditTest extends BaseTest
{
    ...
    static protected $customStylesheets = array(
        ...
        array(
            "path" => "eZ/Publish/Core/FieldType/Tests/XmlText/Converter/Xslt/_fixtures/docbook/custom_stylesheets/docbook_to_xhtml5_edit.xsl",
            "priority" => 99
        ),
    );
     ...
     *
     */
    static protected $outputDir = "eZ/Publish/Core/FieldType/Tests/XmlText/Converter/Xslt/_fixtures/xhtml5/edit";
}
