...
use ArrayObject,
    eZ\Publish\Core\FieldType\Image\Exception\InvalidAlias,
    eZ\Publish\Core\FieldType\Image\Exception\MissingAlias,
...
class AliasCollection extends ArrayObject
{
     ...
     * Image type value
     *
     * @var \eZ\Publish\Core\FieldType\Image\Value
     */
    ...
    /**
     * @var \eZ\Publish\Core\FieldType\Image\Manager
     */
     ...
     * @return \eZ\Publish\Core\FieldType\Image\Alias
     * @throws \eZ\Publish\Core\FieldType\Image\Exception\InvalidAlias when trying to access to an invalid (not configured) image alias
     */
