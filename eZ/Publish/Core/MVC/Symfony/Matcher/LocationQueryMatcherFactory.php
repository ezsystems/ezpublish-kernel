...
class LocationQueryMatcherFactory extends ContentBasedMatcherFactory
{
    /**
    ...
    {
        if (!$valueObject instanceof QueryTypeResult || !$valueObject->query instanceof LocationQuery) {
