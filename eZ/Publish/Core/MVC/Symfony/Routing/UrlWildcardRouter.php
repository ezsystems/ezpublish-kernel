...
use eZ\Publish\API\Repository\Values\Content\URLWildcard as APIUrlWildcard;
...
class UrlWildcardRouter implements ChainedRouterInterface, RequestMatcherInterface
{
    ...
    public function matchRequest(Request $request): array
    {
        ...
        if (isset($this->logger)) {
            $this->logger->info("UrlWildcard matched. Destination URL: {$path}");
        }
     ...
     */
    protected function getUrlWildcard($requestedPath): APIUrlWildcard
    {
     ...
     * @throws NotFoundException
     */
    protected function getUrlWildcardTranslationResult($requestedPath): URLWildcardTranslationResult
    {
