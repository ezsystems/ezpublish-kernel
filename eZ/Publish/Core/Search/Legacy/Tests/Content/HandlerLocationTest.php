...
class HandlerLocationTest extends LanguageAwareTestCase
{
    ...
    public function testFindWithoutOffsetLimit()
    {
        ...
        $searchResult = $handler->findLocations(
            new LocationQuery(
                array(
                    'filter' => new Criterion\Matcher\LocationId(2),
                )
            )
        );
    ...
    public function testParentLocationIdFilter()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\ParentLocationId(5),
                        'limit' => 10,
                    )
                )
            )
                ...
                new LocationQuery(
                    array(
                        'filter' => new Criterion\LogicalOperator\LogicalAnd(
                            array(
                                new Criterion\Matcher\LocationId(
                                    array(4, 12, 13)
                                ),
                                new Criterion\Matcher\LocationId(
                                    array(13, 44)
                    ...
                    array(
                        'filter' => new Criterion\LogicalOperator\LogicalAnd(
                            array(
                                ...
                                new Criterion\Matcher\ParentLocationId(
                                    array(5, 156)
                                ),
                            )
                        ),
    ...
    public function testContentDepthFilterEq()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::EQ, 1),
                        'limit' => 10,
                    )
                )
            )
    ...
    public function testContentDepthFilterIn()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::IN, array(1, 2)),
                        'limit' => 50,
                    )
                )
            )
    ...
    public function testContentDepthFilterBetween()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::BETWEEN, array(0, 1)),
                    )
                )
            )
        );
    ...
    public function testContentDepthFilterGreaterThan()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::GT, 4),
                        'limit' => 50,
                    )
                )
            )
    ...
    public function testContentDepthFilterGreaterThanOrEqual()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::GTE, 5),
                        'limit' => 50,
                    )
                )
            )
    ...
    public function testContentDepthFilterLessThan()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::LT, 2),
                        'limit' => 10,
                    )
                )
            )
    ...
    public function testContentDepthFilterLessThanOrEqual()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Depth(Criterion\Operator::LTE, 2),
                        'limit' => 50,
                    )
                )
            )
    ...
    public function testLocationPriorityFilter()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Location\Priority(
        ...
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\Visibility(
                            Criterion\Matcher\Visibility::HIDDEN
                        ),
                    )
                )
            )
    ...
    public function testContentIdFilterEquals()
    {
        $this->assertSearchResults(
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\Matcher\ContentId(223),
                    )
                )
            )
        );
            ...
            $this->getContentSearchHandler()->findLocations(
                new LocationQuery(
                    array(
                        'filter' => new Criterion\LogicalOperator\LogicalAnd(
                            array(
                                new Criterion\Matcher\ParentLocationId(224),
