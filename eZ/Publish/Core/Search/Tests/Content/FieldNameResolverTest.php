...
namespace eZ\Publish\Core\Search\Tests\Content;
...
class FieldNameResolverTest extends TestCase
{
     ...
     * @param array $methods
     *
     * @return \eZ\Publish\Core\Search\FieldNameResolver|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getMockedFieldNameResolver( array $methods = array() )
    {
        $fieldNameResolver = $this
            ->getMockBuilder(
                "eZ\\Publish\\Core\\Search\\FieldNameResolver"
            )
            ->setConstructorArgs(
                array(
    ...
    /**
     * @var \eZ\Publish\Core\Search\FieldRegistry|\PHPUnit_Framework_MockObject_MockObject
     */
