--TEST--
Test file upload for IOService with Legacy persistence handler
--POST_RAW--
...
$repository = \eZ\Publish\Core\Repository\DomainLogic\Tests\Service\Integration\Legacy\IOUploadPHPT::getRepository( array() );
