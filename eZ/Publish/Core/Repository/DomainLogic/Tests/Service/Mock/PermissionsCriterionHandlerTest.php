<?php
/**
 * File contains: eZ\Publish\Core\Repository\DomainLogic\Tests\Service\Mock\PermissionCriterionHandlerTest class
 *
...
use eZ\Publish\Core\Repository\DomainLogic\PermissionsCriterionHandler;
...
class PermissionCriterionHandlerTest extends BaseServiceMockTest
{
    ...
    {
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\DomainLogic\\PermissionsCriterionHandler",
            $methods,
