...
class ContentTest extends BaseServiceMockTest
{
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\DomainLogic\Helper\DomainMapper
     */
    protected function getDomainMapperMock()
    {
        if (!isset($this->domainMapperMock)) {
            $this->domainMapperMock = $this
                ->getMockBuilder('eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\DomainMapper')
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\DomainLogic\Helper\RelationProcessor
     */
    protected function getRelationProcessorMock()
    {
        if (!isset($this->relationProcessorMock)) {
            $this->relationProcessorMock = $this
                ->getMockBuilder('eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\RelationProcessor')
                ->disableOriginalConstructor()
                ->getMock();
        }
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService
     */
    protected function getNameSchemaServiceMock()
    {
        if (!isset($this->nameSchemaServiceMock)) {
            $this->nameSchemaServiceMock = $this
                ->getMockBuilder('eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\NameSchemaService')
                ->disableOriginalConstructor()
                ->getMock();
        }
