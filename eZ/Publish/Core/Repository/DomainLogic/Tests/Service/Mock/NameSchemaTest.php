...
{
    /**
     * Test eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService method.
     *
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService::resolveUrlAliasSchema
     */
     ...
     * Test eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService method.
     *
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService::resolveNameSchema
     */
     ...
     *
     * @return \eZ\Publish\Core\Repository\DomainLogic\Helper\NameSchemaService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedNameSchemaService(array $methods = null)
    {
        return $this->getMock(
            'eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\NameSchemaService',
            $methods,
            array(
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\DomainLogic\Helper\ContentTypeDomainMapper
     */
    protected function getContentTypeDomainMapperMock()
    {
        if (!isset($this->contentTypeDomainMapperMock)) {
            $this->contentTypeDomainMapperMock = $this
                ->getMockBuilder('eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\ContentTypeDomainMapper')
