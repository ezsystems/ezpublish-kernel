...
/**
 * File contains: eZ\Publish\Core\Repository\DomainLogic\Tests\Service\Mock\DomainMapperTest class.
 *
...
use eZ\Publish\Core\Repository\DomainLogic\Helper\DomainMapper;
...
{
    /**
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\DomainMapper::buildVersionInfoDomainObject
    ...
    public function testBuildVersionInfo(SPIVersionInfo $spiVersionInfo, array $languages, array $expected)
    {
        ...
        $this->assertInstanceOf('eZ\\Publish\\Core\\Repository\\DomainLogic\\Values\\Content\\VersionInfo', $versionInfo);
