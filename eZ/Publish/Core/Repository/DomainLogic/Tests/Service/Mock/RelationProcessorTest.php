...
class RelationProcessorTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\RelationProcessor::__construct
     */
     ...
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\RelationProcessor::appendFieldRelations
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\RelationProcessor::processFieldRelations
     */
     ...
     *
     * @return \eZ\Publish\Core\Repository\DomainLogic\Helper\RelationProcessor|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedRelationProcessor(array $methods = null)
    {
        return $this->getMock(
            'eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\RelationProcessor',
            $methods,
            array(
                $this->getPersistenceMock(),
            )
