...
class RoleTest extends BaseServiceMockTest
{
     ...
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\LimitationService::validateLimitations
     * @covers \eZ\Publish\Core\Repository\DomainLogic\Helper\LimitationService::validateLimitation
        ...
        if (!isset($this->partlyMockedRoleService) || !empty($settings)) {
            $this->partlyMockedRoleService = $this->getMock(
                ...
                array(
                    ...
                    $this->getMock(
                        'eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\RoleDomainMapper',
                        array(),
     ...
     * @param array $settings
     *
     * @return \eZ\Publish\Core\Repository\DomainLogic\Helper\LimitationService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedLimitationService(array $methods = null, array $settings = array())
    {
        if (!isset($this->partlyMockedLimitationService) || !empty($settings)) {
            $this->partlyMockedLimitationService = $this->getMock(
                'eZ\\Publish\\Core\\Repository\\DomainLogic\\Helper\\LimitationService',
                $methods,
                array(
                    $settings,
                )
