    ...
    public function serviceProvider()
    {
        ...
        return array(
            ...
            array(
                ...
                $role,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\CreateRoleDraftSignal',
                array('roleId' => $roleId),
            ),
            array(
                'updateRole',
            ...
            array(
                ...
                $roleDraft,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\UpdateRoleDraftSignal',
                array('roleId' => $roleId),
            ),
            array(
                'publishRoleDraft',
                ...
                $roleDraft,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\PublishRoleDraftSignal',
                array('roleId' => $roleId),
            ),
            array(
                'addPolicy',
            ...
            array(
                ...
                $roleDraft,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\AddPolicyByRoleDraftSignal',
                array(
                    'roleId' => $roleId,
                    'policyId' => $roleId,
                ),
            ...
            array(
                ...
                $roleDraft,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\RemovePolicyByRoleDraftSignal',
                array(
                    'roleId' => $roleId,
                    'policyId' => $policyId,
                ),
            ...
            array(
                ...
                null,
                1,
                'eZ\Publish\Core\Repository\SignalSlot\Signal\RoleService\DeleteRoleDraftSignal',
                array('roleId' => $roleId),
            ),
            array(
