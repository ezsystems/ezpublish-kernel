...
class ContentService implements ContentServiceInterface
{
     ...
     *
     * @param int $contentId
     * @param array $languages Languages priority list, get first or fallback to next (finally fallback to main language if available)
     *
     ...
     * @param int $versionNo the version number. If not given the current version is returned.
     * @param array $languages Languages priority list, get first or fallback to next
     *
     * @return \eZ\Publish\API\Repository\Values\Content\VersionInfo
     */
