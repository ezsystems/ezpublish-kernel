<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\RelationProcessorTest class
 *
...
use eZ\Publish\Core\Repository\Permission\Values\ContentType\FieldDefinition;
...
class RelationProcessorTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\RelationProcessor::__construct
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\RelationProcessor::getFieldRelations
     */
     ...
     * @covers \eZ\Publish\Core\Repository\Permission\RelationProcessor::appendFieldRelations
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\RelationProcessor::processFieldRelations
     */
    ...
    {
        return new \eZ\Publish\Core\Repository\Permission\Values\Content\Relation(
            array(
                "id" => $id,
                "type" => $type,
     ...
     *
     * @return \eZ\Publish\Core\Repository\Permission\RelationProcessor|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedRelationProcessor( array $methods = null )
    {
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\RelationProcessor",
            $methods,
            array(
                $this->getRepositoryMock(),
                $this->getPersistenceMock()
    ...
    {
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\FieldTypeService",
            array(),
            array(),
            '',
            false
