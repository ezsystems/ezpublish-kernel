<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest class
 *
...
use eZ\Publish\Core\Repository\Permission\ContentService;
...
class ContentTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::__construct
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::loadVersionInfoById
     */
     ...
     * Test for the loadVersionInfo() method.
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::loadVersionInfo
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest::testLoadVersionInfoById
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest::testLoadVersionInfoByIdThrowsNotFoundException
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest::testLoadVersionInfoByIdThrowsUnauthorizedExceptionNonPublishedVersion
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest::testLoadVersionInfoByIdPublishedVersion
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\ContentTest::testLoadVersionInfoByIdNonPublishedVersion
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::loadContentByContentInfo
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::loadContentByVersionInfo
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::deleteContent
     * @expectedException \eZ\Publish\Core\Base\Exceptions\UnauthorizedException
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::createContent
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::getLanguageCodesForCreate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::mapFieldsForCreate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::cloneField
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::getDefaultObjectStates
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::createContent
     ...
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::getLanguageCodesForCreate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::mapFieldsForCreate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::buildSPILocationCreateStructs
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::createContent
     */
     ...
     * Test for the updateContent() method.
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::updateContent
     ...
     * @param string $initialLanguageCode
     * @param \eZ\Publish\API\Repository\Values\Content\Field[] $structFields
     * @param \eZ\Publish\Core\Repository\Permission\Values\Content\Content $content
     * @param \eZ\Publish\API\Repository\Values\ContentType\FieldDefinition[] $fieldDefinitions
     * @param array $languageCodes
     *
     * @return array
     ...
     * Testing the simplest use case.
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::getLanguageCodesForUpdate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::mapFieldsForUpdate
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::updateContent
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::copyContent
     * @expectedException \eZ\Publish\Core\Base\Exceptions\UnauthorizedException
     */
     ...
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::copyContent
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::getDefaultObjectStates
     * @covers \eZ\Publish\Core\Repository\Permission\ContentService::internalPublishVersion
     */
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\Permission\DomainMapper
     */
    protected function getDomainMapperMock()
    {
        if ( !isset( $this->domainMapperMock ) )
        {
            $this->domainMapperMock = $this
                ->getMockBuilder( "eZ\\Publish\\Core\\Repository\\Permission\\DomainMapper" )
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\Permission\RelationProcessor
     */
    protected function getRelationProcessorMock()
    {
        if ( !isset( $this->relationProcessorMock ) )
        {
            $this->relationProcessorMock = $this
                ->getMockBuilder( "eZ\\Publish\\Core\\Repository\\Permission\\RelationProcessor" )
                ->disableOriginalConstructor()
                ->getMock();
        }
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\Repository\Permission\NameSchemaService
     */
    protected function getNameSchemaServiceMock()
    {
        if ( !isset( $this->nameSchemaServiceMock ) )
        {
            $this->nameSchemaServiceMock = $this
                ->getMockBuilder( "eZ\\Publish\\Core\\Repository\\Permission\\NameSchemaService" )
                ->disableOriginalConstructor()
                ->getMock();
        }
    ...
    protected function getFieldTypeServiceMock()
    {
        if ( !isset( $this->fieldTypeServiceMock ) )
        {
            $this->fieldTypeServiceMock = $this
                ->getMockBuilder( "eZ\\Publish\\Core\\Repository\\Permission\\FieldTypeService" )
                ->disableOriginalConstructor()
                ->getMock();
        }
    ...
    /**
     * @var \eZ\Publish\Core\Repository\Permission\ContentService
     */
     ...
     *
     * @return \eZ\Publish\Core\Repository\Permission\ContentService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedContentService( array $methods = null )
    {
        if ( !isset( $this->partlyMockedContentService ) )
        {
            $this->partlyMockedContentService = $this->getMock(
                "eZ\\Publish\\Core\\Repository\\Permission\\ContentService",
                $methods,
                array(
