<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\UrlWildcardTest class
 *
...
namespace eZ\Publish\Core\Repository\Permission\Tests\Service\Integration;
...
class UrlWildcardTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\URLWildcardService::__construct
     */
     ...
     * @covers \eZ\Publish\Core\Repository\Permission\URLWildcardService::create
     ...
     *
     * @depends testConstructor
     * @covers \eZ\Publish\Core\Repository\Permission\URLWildcardService::remove
     * @expectedException \eZ\Publish\API\Repository\Exceptions\UnauthorizedException
     */
     ...
     *
     * @depends testConstructor
     * @covers \eZ\Publish\Core\Repository\Permission\URLWildcardService::loadAll
     */
     ...
     *
     * @depends testConstructor
     * @covers \eZ\Publish\Core\Repository\Permission\URLWildcardService::translate
     ...
     *
     * @return \eZ\Publish\Core\Repository\Permission\URLWildcardService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedURLWildcardService( array $methods = null )
    {
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\URLWildcardService",
            $methods,
            array(
