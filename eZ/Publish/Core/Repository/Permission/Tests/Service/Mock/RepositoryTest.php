<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\RepositoryTest class
 *
...
class RepositoryTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\Repository::sudo
     * @covers \eZ\Publish\API\Repository\Repository::hasAccess
     * @dataProvider providerForTestHasAccessReturnsFalse
     */
    ...
    public function testHasAccessReturnsPermissionSets( array $roles, array $roleAssignments )
    {
        ...
        $repositoryMock = $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\Repository",
        ...
        /** @var $repositoryMock \eZ\Publish\Core\Repository\Permission\Repository */
        self::assertEquals(
            $permissionSets,
