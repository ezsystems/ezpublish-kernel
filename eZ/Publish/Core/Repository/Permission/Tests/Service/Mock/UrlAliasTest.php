<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\UrlAliasTest class
 *
...
use eZ\Publish\Core\Repository\Permission\URLAliasService;
...
use eZ\Publish\Core\Repository\Permission\Values\Content\Location;
...
class UrlAliasTest extends BaseServiceMockTest
{
    ...
    public function testConstructor()
    {
        ...
        $languageServiceMock = $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\LanguageService",
            array(), array(), "", false
        );
     ...
     * Test for the createGlobalUrlAlias() method.
     *
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\UrlAliasTest::testCreateUrlAlias
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\UrlAliasTest::testCreateUrlAliasWithRollback
     * @depends eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\UrlAliasTest::testCreateUrlAliasThrowsInvalidArgumentException
     */
    public function testCreateGlobalUrlAliasForLocation()
    {
        ...
        $locationServiceMock = $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\LocationService",
            array(), array(), "", false
        );
     ...
     * @param int $id
     *
     * @return \eZ\Publish\Core\Repository\Permission\Values\Content\Location
     */
     ...
     *
     * @return \eZ\Publish\Core\Repository\Permission\URLAliasService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedURLAliasServiceService( array $methods = null )
    {
        ...
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\URLAliasService",
            $methods,
            array(
