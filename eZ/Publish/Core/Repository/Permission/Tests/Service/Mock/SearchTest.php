<?php
/**
 * File contains: eZ\Publish\Core\Repository\Permission\Tests\Service\Mock\SearchTest class
 *
...
use eZ\Publish\Core\Repository\Permission\SearchService;
...
class SearchTest extends BaseServiceMockTest
{
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\SearchService::__construct
     */
     ...
     *
     * @covers \eZ\Publish\Core\Repository\Permission\PermissionsCriterionHandler::addPermissionsCriterion
     * @covers \eZ\Publish\Core\Repository\Permission\PermissionsCriterionHandler::getPermissionsCriterion
     * @covers \eZ\Publish\Core\Repository\Permission\SearchService::findContent
     ...
     * @covers \eZ\Publish\Core\Repository\Permission\PermissionsCriterionHandler::addPermissionsCriterion
     * @covers \eZ\Publish\Core\Repository\Permission\PermissionsCriterionHandler::getPermissionsCriterion
     * @covers \eZ\Publish\Core\Repository\Permission\SearchService::findSingle
    ...
    protected function getPermissionsCriterionHandlerMock()
    {
        if ( !isset( $this->permissionsCriterionHandlerMock ) )
        {
            $this->permissionsCriterionHandlerMock = $this
                ->getMockBuilder( "eZ\\Publish\\Core\\Repository\\Permission\\PermissionsCriterionHandler" )
                ->disableOriginalConstructor()
                ->getMock();
        }
     ...
     *
     * @return \eZ\Publish\Core\Repository\Permission\SearchService|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getPartlyMockedSearchService( array $methods = array() )
    {
        return $this->getMock(
            "eZ\\Publish\\Core\\Repository\\Permission\\SearchService",
            $methods,
            array(
