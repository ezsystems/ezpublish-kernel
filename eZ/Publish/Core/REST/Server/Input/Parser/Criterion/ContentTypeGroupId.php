...
use eZ\Publish\API\Repository\Values\Content\Query\Criterion\Matcher\ContentTypeGroupId as ContentTypeGroupIdCriterion;
...
class ContentTypeGroupId extends BaseParser
{
     ...
     *
     * @return ContentTypeGroupIdCriterion
     */
