    ...
    public function publishUrlAliasForLocation( $locationId, $parentLocationId, $name, $languageCode, $alwaysAvailable = false )
    {
        ...
        while ( true )
        {
            ...
            if ( !isset( $reusableAlias ) )
            {
                ...
                {
                    $this->historizeAndUpdateExistingAlias( $data, $existingAlias, $languageCode, $name, $alwaysAvailable );
                }
                else
                {
                    $this->createNewAlias( $this->getNextLinkId(), $data, $languageCode, $name, $alwaysAvailable );
                }
                ...
                || $reusableAlias->isHistory )
            {
                ...
                {
                    $this->downgrade( $reusableAlias, $languageCode );
                    $this->createNewAlias( $reusableAlias->id["link"], $data, $languageCode, $name, $alwaysAvailable );
                }
