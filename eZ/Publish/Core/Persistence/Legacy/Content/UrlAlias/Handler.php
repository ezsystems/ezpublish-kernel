...
class Handler implements UrlAliasHandlerInterface
{
    ...
    public function publishUrlAliasForLocation(
        ...
        // This is intentionally hardcoded and not exposed as:
        // 1. we don't implement this configuration option
        // 2. such option should have no place here
        // This solution is temporary until we can break data compatibility with Legacy Stack.
        $contentTreeRootLocationId = 2;
        if ($locationId == $contentTreeRootLocationId) {
            $newText = '';
