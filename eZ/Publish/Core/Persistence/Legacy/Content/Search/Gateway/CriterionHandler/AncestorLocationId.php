<?php
/**
 * File containing the EzcDatabase ancestor location id criterion handler class
 *
...
/**
 * Ancestor location id criterion handler
 */
class AncestorLocationId extends CriterionHandler
{
    /**
    ...
    {
        return $criterion instanceof Criterion\AncestorLocationId;
    }
