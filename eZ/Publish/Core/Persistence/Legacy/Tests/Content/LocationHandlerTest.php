...
class LocationHandlerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->treeHandler = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\TreeHandler', [], [], '', false);
        $this->contentHandler = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\Handler', [], [], '', false);
    }
    ...
    protected function getLocationHandler()
    {
        ...
        return new Handler(
            ...
            $this->locationMapper,
            $this->contentHandler,
            $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\ObjectState\\Handler', [], [], '', false),
            $this->treeHandler
        );
    }
    ...
    protected function getPartlyMockedHandler(array $methods)
    {
        return $this->getMock(
            ...
            $methods,
            [
                $this->locationGateway = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\Location\\Gateway', [], [], '', false),
                $this->locationMapper = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\Location\\Mapper', [], [], '', false),
                $this->contentHandler = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\Handler', [], [], '', false),
                $this->objectStateHandler = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\ObjectState\\Handler', [], [], '', false),
                $this->treeHandler = $this->getMock('eZ\\Publish\\Core\\Persistence\\Legacy\\Content\\TreeHandler', [], [], '', false),
            ]
        );
    }
