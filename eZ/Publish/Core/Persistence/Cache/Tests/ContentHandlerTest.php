...
class ContentHandlerTest extends AbstractCacheHandlerTest
{
    ...
    public function providerForCachedLoadMethods(): array
    {
        ...
        return [
            ...
            ['loadContentList', [[2]], 'ez-content-2-' . ContentHandler::ALL_TRANSLATIONS_KEY, [2 => $content], true, [], true],
            ['loadContentList', [[5], ['eng-GB', 'eng-US']], 'ez-content-5-eng-GB|eng-US', [5 => $content], true, [], true],
            ['loadContentInfo', [2], 'ez-content-info-2', $info],
            ['loadContentInfoList', [[2]], 'ez-content-info-2', [2 => $info], true, [], true],
