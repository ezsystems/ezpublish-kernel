<?php
/**
 * File containing the range PriorityRange Priority criterion visitor class
 *
...
/**
 * Visits the Priority criterion with range operators (LT, LTE, GT, GTE and BETWEEN)
 */
class PriorityRange extends CriterionVisitor
{
    /**
