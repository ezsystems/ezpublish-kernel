...
class Repository implements RepositoryInterface
{
     ...
     */
    public function __construct( RepositoryInterface $repository, CachePool $cachePool )
    {
    ...
    public function getContentService()
    {
        ...
        $this->contentService = new ContentService( $this->repository->getContentService(), $this->cachePool );
        return $this->contentService;
    }
    ...
    public function getContentLanguageService()
    {
        ...
        $this->languageService = new LanguageService( $this->repository->getContentLanguageService(), $this->cachePool );
        return $this->languageService;
    }
    ...
    public function getContentTypeService()
    {
        ...
        $this->contentTypeService = new ContentTypeService( $this->repository->getContentTypeService(), $this->cachePool );
        return $this->contentTypeService;
    }
    ...
    public function getLocationService()
    {
        ...
        $this->locationService = new LocationService( $this->repository->getLocationService(), $this->cachePool );
        return $this->locationService;
    }
    ...
    public function getTrashService()
    {
        ...
        $this->trashService = new TrashService( $this->repository->getTrashService(), $this->cachePool );
        return $this->trashService;
    }
    ...
    public function getSectionService()
    {
        ...
        $this->sectionService = new SectionService( $this->repository->getSectionService(), $this->cachePool );
        return $this->sectionService;
    }
    ...
    public function getUserService()
    {
        ...
        $this->userService = new UserService( $this->repository->getUserService(), $this->cachePool );
        return $this->userService;
    }
    ...
    public function getURLAliasService()
    {
        ...
        $this->urlAliasService = new URLAliasService( $this->repository->getURLAliasService(), $this->cachePool );
        return $this->urlAliasService;
    }
    ...
    public function getURLWildcardService()
    {
        ...
        $this->urlWildcardService = new URLWildcardService( $this->repository->getURLWildcardService(), $this->cachePool );
        return $this->urlWildcardService;
    }
    ...
    public function getObjectStateService()
    {
        ...
        $this->objectStateService = new ObjectStateService( $this->repository->getObjectStateService(), $this->cachePool );
        return $this->objectStateService;
    }
    ...
    public function getRoleService()
    {
        ...
        $this->roleService = new RoleService( $this->repository->getRoleService(), $this->cachePool );
        return $this->roleService;
    }
    ...
    public function getSearchService()
    {
        ...
        $this->searchService = new SearchService( $this->repository->getSearchService(), $this->cachePool );
        return $this->searchService;
    }
    ...
    public function getFieldTypeService()
    {
        ...
        $this->fieldTypeService = new FieldTypeService( $this->repository->getFieldTypeService(), $this->cachePool );
        return $this->fieldTypeService;
    }
