...
{
    public const NAME = 'ezplatform.event.role.assign_to_user_group.before';
    ...
    public function __construct(Role $role, UserGroup $userGroup, RoleLimitation $roleLimitation)
    {
        $this->role = $role;
