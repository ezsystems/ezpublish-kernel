...
class URLAliasServiceTest extends AbstractServiceTest
{
    ...
    public function testReturnCreateGlobalUrlAliasResultInBeforeEvents()
    {
        ...
        $traceableEventDispatcher->addListener(BeforeCreateGlobalUrlAliasEvent::class, function (\eZ\Publish\API\Repository\Events\URLAlias\BeforeCreateGlobalUrlAliasEvent $event) use ($eventUrlAlias) {
    ...
    public function testRefreshSystemUrlAliasesForLocationStopPropagationInBeforeEvents()
    {
        ...
        $traceableEventDispatcher->addListener(BeforeRefreshSystemUrlAliasesForLocationEvent::class, function (\eZ\Publish\API\Repository\Events\URLAlias\BeforeRefreshSystemUrlAliasesForLocationEvent $event) {
            $event->stopPropagation();
        }, 10);
    ...
    public function testReturnCreateUrlAliasResultInBeforeEvents()
    {
        ...
        $traceableEventDispatcher->addListener(BeforeCreateUrlAliasEvent::class, function (\eZ\Publish\API\Repository\Events\URLAlias\BeforeCreateUrlAliasEvent $event) use ($eventUrlAlias) {
            $event->setUrlAlias($eventUrlAlias);
        }, 10);
    ...
    public function testRemoveAliasesStopPropagationInBeforeEvents()
    {
        ...
        $traceableEventDispatcher->addListener(BeforeRemoveAliasesEvent::class, function (\eZ\Publish\API\Repository\Events\URLAlias\BeforeRemoveAliasesEvent $event) {
            $event->stopPropagation();
        }, 10);
