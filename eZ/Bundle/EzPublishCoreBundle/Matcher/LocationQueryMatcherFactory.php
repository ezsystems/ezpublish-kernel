...
class LocationQueryMatcherFactory extends BaseMatcherFactory implements SiteAccessAware, ContainerAwareInterface
{
    /**
    ...
    public function __construct(ConfigResolverInterface $configResolver, Repository $repository)
    {
        ...
        parent::__construct(
            $repository,
            $this->configResolver->getParameter('location_query_view')
        );
    }
    ...
    public function setSiteAccess(SiteAccess $siteAccess = null)
    {
        ...
        $this->matchConfig = $this->configResolver->getParameter('location_query_view', 'ezsettings', $siteAccess->name);
    }
}
