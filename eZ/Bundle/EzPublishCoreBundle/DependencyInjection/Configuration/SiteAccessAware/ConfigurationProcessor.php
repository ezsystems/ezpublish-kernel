...
class ConfigurationProcessor
{
    ...
    {
        return new Contextualizer($containerBuilder, $namespace, $siteAccessNodeName, static::$availableSiteAccesses, static::$availableSiteAccessGroups, static::$groupsBySiteAccess);
    }
