<?php
/**
 * File containing the Configured Block View Provider class.
 *
...
namespace eZ\Bundle\EzPublishCoreBundle\View\Provider\Block;

use eZ\Publish\Core\MVC\Symfony\View\Provider\Block\Configured as BaseConfigured;
...
class Configured extends BaseConfigured
{
    ...
    public function __construct( ConfigResolverInterface $configResolver, Repository $repository, ContainerInterface $container )
    {
        ...
        parent::__construct( $repository, $configResolver->getParameter( 'block_view' ) );
    }
