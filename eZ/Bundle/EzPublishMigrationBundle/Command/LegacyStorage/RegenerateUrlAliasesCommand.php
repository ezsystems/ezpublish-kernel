...
/**
 * @deprecated since 7.3, use the ezplatform:urls:regenerate-aliases command instead.
 */
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        @trigger_error(
            sprintf(
                '%s is deprecated since 7.3. Use the ezplatform:urls:regenerate-aliases command instead.',
                $this->getName()
            ),
            E_USER_DEPRECATED
        );
