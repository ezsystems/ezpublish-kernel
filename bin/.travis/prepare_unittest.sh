...
if [ "$TEST_CONFIG" = "phpunit-integration-legacy-solr.xml" ] ; then
    ...
    echo "> Require ezsystems/ezplatform-solr-search-engine:'dev-symfony5 as 3.0.x-dev'"
    composer require --no-update ezsystems/ezplatform-solr-search-engine:'dev-symfony5 as 3.0.x-dev'
fi
