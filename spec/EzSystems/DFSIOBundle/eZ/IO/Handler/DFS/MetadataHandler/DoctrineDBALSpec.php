...
namespace spec\EzSystems\DFSIOBundle\eZ\IO\Handler\DFS\MetadataHandler;

use Doctrine\DBAL;
use EzSystems\DFSIOBundle\eZ\IO\Handler\DFS\MetadataHandler\DoctrineDBAL\QueryProviderInterface;
...
class DoctrineDBALSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('EzSystems\DFSIOBundle\eZ\IO\Handler\DFS\MetadataHandler\DoctrineDBAL');
    }
